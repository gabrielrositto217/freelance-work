...
SELECT 
	...
	-- Gabriel@Barney: Same remark as the others, multiply times 100 and analyze whether formatting is correct
    CONCAT(round((bill.successful_billings / bill.attempted_billings),2),'%') as 'Billing Sucess Rate',

	-- Gabriel@Barney: Suggestion - If possible leave all amounts as numbers and let formatting be done by the devs team (or Quicksight), else if this is not possible we can keep it this way
